<?php 
    ...
    if(isset($_POST['update']))
    {
        ...
        // $prof_img_temp=$_FILES['c_iprof_imgmage']['tmp_name'];
        
        // move_uploaded_file($prof_img_temp , "customer_images/$prof_img");
        ...
        // $result = mysqli_query($conn, "UPDATE users SET username='$username',email='$email',
        // password='$password',gender='$gender',phone='$phone',prof_img='$prof_imgID' WHERE id=$id");
    ...
    // $phone = $user_data['gender'];
    // $prof_img = $user_data['prof_img']['tmp_name'];
    // $prof_imgID = addslashes(file_get_contents($prof_img));
