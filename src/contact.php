...
<head>
    ...
    <link rel="stylesheet" href="https://car-tch.herokuapp.com/css/contact.css" />
            ...
            <div class="row">
                <div class="ContactForm col-6">
                    <form class="Mail"  method="POST"
                            ...
                            <h3>Contact Us<img src="https://car-tch.herokuapp.com/imgs/contactUs_Tittle.png" width="50px"></h3>
                            <span>Name</span>
                ...
                <div class="img_contact col-6 wow bounceInRight">
                    <img class="img_Form" src="https://car-tch.herokuapp.com/imgs/ContactUsForm.png">
                </div>
            </div>	
        </div>
    </div>
