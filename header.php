                ...
                <ul class="navbar-nav navar ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <?php
                            ...
                            {
                                if (isset($_SESSION['p_id']))   
                                   { echo "<a aria-hidden='true' class='dropdown-item fa fa-sign-out' style='color:#08526d' href='/Car-Tech-TeamB/src/logoutP.php'> Logout</a>" ;}
                                else
                                    { echo "<a aria-hidden='true' class='dropdown-item fa fa-sign-out' style='color:#08526d' href='/Car-Tech-TeamB/src/logoutU.php'> Logout</a>"; }
                            }
                            else
                            {
